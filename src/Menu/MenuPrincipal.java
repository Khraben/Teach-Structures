...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Lista Simple Circular");
        ...
        jButton6.setText("Lista Doble Circular");
        ...
        jButton7.setFont(new java.awt.Font("HP Simplified Light", 3, 16)); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font("Bahnschrift", 2, 28)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(153, 153, 153));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Seleccione el Tipo de Estructura");
        jLabel2.setToolTipText("");

        jLabel3.setFont(new java.awt.Font("Bahnschrift", 2, 28)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 153, 153));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("con el Que Desea Trabajar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Diseños.FrameSimple sigVentana = new Diseños.FrameSimple();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Diseños.FrameSublista sigVentana = new Diseños.FrameSublista();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Diseños.FrameSimpleCircular sigVentana = new Diseños.FrameSimpleCircular();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Diseños.FrameGrafos sigVentana = new Diseños.FrameGrafos();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Diseños.FrameDobleCircular sigVentana = new Diseños.FrameDobleCircular();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Diseños.FrameDoble sigVentana = new Diseños.FrameDoble();
        sigVentana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        Diseños.FrameArbol sigVentana = new Diseños.FrameArbol();
        sigVentana.setVisible(true);
        this.dispose();
