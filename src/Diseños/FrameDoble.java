...
import Img.Doble.mostrarCode;
import ListaDoble.metodosDoble;
...
public class FrameDoble extends javax.swing.JFrame implements AdjustmentListener {

    int tamaño = 758;
    metodosDoble met = new metodosDoble();
    Lienzos lienzo;
    JScrollPane scroll;

    public FrameDoble() {
        initComponents();
        setTitle("Trabajando en: Lista Doble");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDoble().setVisible(true);
            }
        });
    }
