...
import Img.SimpleCircular.mostrarCode;
import ListaSimpleCircular.metodosSimpleCircular;
...
public class FrameSimpleCircular extends javax.swing.JFrame implements AdjustmentListener {

    int tamaño = 758;
    metodosSimpleCircular met = new metodosSimpleCircular();
    Lienzos lienzo;
    JScrollPane scroll;

    public FrameSimpleCircular() {
        initComponents();
        setTitle("Trabajando en: Lista Simple Circular");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSimpleCircular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameSimpleCircular().setVisible(true);
            }
        });
    }
