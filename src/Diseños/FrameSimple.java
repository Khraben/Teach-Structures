...
import Img.Simple.mostrarCode;
import ListaSimple.metodosSimple;
...
public class FrameSimple extends javax.swing.JFrame implements AdjustmentListener {

    int tamaño = 758;
    metodosSimple met = new metodosSimple();
    Lienzos lienzo;
    JScrollPane scroll;

    public FrameSimple() {
        initComponents();
        setTitle("Trabajando en: Lista Simple");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSimple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
