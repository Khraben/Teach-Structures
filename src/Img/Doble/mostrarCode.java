...
public class mostrarCode extends javax.swing.JFrame {
    ...
    public void cambiarImg() {
        if (img == 1) {
            jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/Doble/insertarInicio.png")));
        } else {
            if (img == 2) {
                jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/Doble/insertarFinal.png")));
            } else {
                if (img == 3) {
                    jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/Doble/insertarOrdenado.png")));
                } else {
                    if (img == 4) {
                        jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/Doble/modificar.png")));
                    } else {
                        if (img == 5) {
                            jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/Doble/eliminar.png")));
                        }
                    }
                }
            }
